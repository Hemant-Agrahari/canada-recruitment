...
import GoogleCaptchaWrapper from "../../captcha/google-captcha-wrapper"; // Assuming you have a GoogleCaptchaWrapper component for the reCAPTCHA
    ...
    const fetchCountries = async () => {
      try {
        const response = await axios.get(
          "https://allianceintbackend.aistechnolabs.pro/getCountries"
        );
        setCountries(response.data.data); // Assuming the API returns an array of countries
      } catch (error) {
      ...
      try {
        ...
        if (data && data.countryCode) {
          const selectedCountry: any = countries.find(
            (country: any) => country.code === data.countryCode
          );
          if (selectedCountry) {
          ...
          console.error("Country data not available in response");
        }
      } catch (error) {
        if (retryCount > 0) {
          setTimeout(() => retryRequest(retryCount - 1), 2000); // Retry after 2 seconds
        } else {
          console.error("Error fetching IP geolocation after retries:", error);
        }
      }
    };

    retryRequest(); // Start with the initial request
  };
                ...
                <div className="button-box">
                  <div className="l-button">
                    <div className="icon-box">
                      <Image
                        src="/assets/images/common/briefcase.svg"
                        width={24}
                        height={24}
                        alt=""
                      />
                  ...
                  <div className="r-button">
                    <div className="icon-box">
                      <Image
                        src="/assets/images/common/magnifying-glass.svg"
                        width={24}
                        height={24}
                        alt=""
                      />
                ...
                <div className="form-wrapper">
                  <form
                    onSubmit={(e) => {
                      ...
                      formik.handleSubmit(); // Trigger Formik's handleSubmit
                    }}
                  >
                    <div className="row g-3 g-md-4 justify-content-center">
                      ...
                      <div className="col-8 col-md-5">
                        <button type="submit" className="submit-button" id="reach-submit">
                          Submit
                        </button>
                      </div>
                    </div>
